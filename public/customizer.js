...
export const customizer = () => {
    ...
    const INITIAL_MAP = [
    { childID: "eyelets", mtl: INITIAL_MTL },
    { childID: "laces", mtl: INITIAL_MTL },
    { childID: "sole", mtl: INITIAL_MTL },
    { childID: "upper_1", mtl: INITIAL_MTL },
    { childID: "upper_2", mtl: INITIAL_MTL }
    ];
    ...
    // Add lights
    var hemiLight = new THREE.HemisphereLight(0xffffff, 0x404040, 0.61);
    ...
    return (
        <>
            ...
            <div class="controls">
                <div class="options">
                    <div class="option --is-active" data-option="eyelets">
                        <span>シューレース</span>
                    </div>
